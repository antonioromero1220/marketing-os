...
var ColorValidationSchema = import_zod.z.object({
  primary: import_zod.z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color format"),
  secondary: import_zod.z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color format").optional(),
  accent: import_zod.z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color format").optional(),
  neutral: import_zod.z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color format").optional()
});
var FontValidationSchema = import_zod.z.object({
  heading: import_zod.z.string().min(1, "Heading font is required").optional(),
  body: import_zod.z.string().min(1, "Body font is required").optional(),
  accent: import_zod.z.string().min(1, "Accent font name is required").optional()
});
